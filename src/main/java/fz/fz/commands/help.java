...
public class help implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.GRAY+"/tpa <玩家名> - "+ChatColor.YELLOW+" TPA玩家"+ChatColor.RED+"(/tpa help获取tpa帮助)");
        ...
        sender.sendMessage(ChatColor.GRAY+"/514 - " +ChatColor.YELLOW+ "自杀"+ChatColor.RED+"(/4 /suicide 作用相同)");
